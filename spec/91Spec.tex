...
\item
\addendum{Механизмы} контроля времени выполнения криптографических 
...
\item
\addendum{Механизмы} защиты от создания неявных копий
...
\item
Действия при срабатывании \addendum{механизмов} контроля 
...
\item
\addendum{Д}оверенный канал (при включении пакета ДК).
